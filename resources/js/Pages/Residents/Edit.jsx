...
export default function Edit({ resident }) {
  ...
  return (
    <>
      <Head title={`Chỉnh sửa: ${resident?.name ?? 'Cư dân'}`} />

      {/* HERO giống layout ảnh */}
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="mx-auto max-w-7xl px-4">
            ...
            <p className="mt-1 text-white/80 max-w-xl text-sm">
              Cập nhật thông tin cư dân và lưu thay đổi.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 py-6">
          <div className="mx-auto max-w-3xl rounded-2xl border bg-white shadow-sm p-6">
            ...
            <form onSubmit={submit} className="grid grid-cols-1 gap-4">
              ...
              {/* Nếu có danh sách căn hộ, thay input này bằng <select> options */}
              <Field
